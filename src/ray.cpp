...
bool hit(ray *ray_in, triangle *tri, float *t, hit_data *data)
{
   ...
   mat3 A (
         tri->pts[0]->coord[0] - tri->pts[1]->coord[0],
         tri->pts[0]->coord[0] - tri->pts[2]->coord[0],
         ray_in->dir[0],
         tri->pts[0]->coord[1] - tri->pts[1]->coord[1],
         tri->pts[0]->coord[1] - tri->pts[2]->coord[1],
         ray_in->dir[1],
         tri->pts[0]->coord[2]-tri->pts[1]->coord[2],
         tri->pts[0]->coord[2]-tri->pts[2]->coord[2],
         ray_in->dir[2]
   );
   ...
   mat3 baryT (
         tri->pts[0]->coord[0]-tri->pts[1]->coord[0],
         tri->pts[0]->coord[0]-tri->pts[2]->coord[0],
         tri->pts[0]->coord[0]-ray_in->pt[0],
         tri->pts[0]->coord[1]-tri->pts[1]->coord[1],
         tri->pts[0]->coord[1]-tri->pts[2]->coord[1],
         tri->pts[0]->coord[1]-ray_in->pt[1],
         tri->pts[0]->coord[2]-tri->pts[1]->coord[2],
         tri->pts[0]->coord[2]-tri->pts[2]->coord[2],
         tri->pts[0]->coord[2]-ray_in->pt[2]
   );
